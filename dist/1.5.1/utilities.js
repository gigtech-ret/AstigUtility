/*! 
 ...
 VERSION: 1.5.1 
 AUTHOR: ארון מנלגניט 
 GITHUB: https://github.com/ret-gigtech/
 LATEST BUILD DATE AND TIME: April 22, 2021 12:59 PM PHILIPPINE TIME*/
(function(){
    'use strict';
...
(function () {
    ...
    function utilityService($filter, $window) {
        ...
        this.countries_state_cities = countryStateCities;
        ...
        function countryStateCities() {
            return "../json/countries_states_cities.json";
        }
    }
})();
(function(){
